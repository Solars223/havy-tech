...
extern uint8_t data_airpods[26];
extern uint8_t data_airpods_pro[26];
extern uint8_t data_airpods_max[26];
extern uint8_t data_airpods_gen2[26];
extern uint8_t data_airpods_gen3[26];
extern uint8_t data_airpods_pro_gen2[26];
extern uint8_t data_beats_solo_pro[26];
extern uint8_t data_beats_studio_buds[26];
extern uint8_t data_beats_fit_pro[26];
extern uint8_t data_beats_studio_buds_plus[26];
extern uint8_t data_apple_tv_setup[21];
extern uint8_t data_setup_new_phone[21];
extern uint8_t data_transfer_number[21];
extern uint8_t data_tv_color_balance[21];
